...
EDITABLE = [
    ...
    {"key": _k("MAX_CANDIDATES_PER_DAY", "limits.max_candidates_per_day"), "label": "Кандидатов в день", "attr": "max_candidates_per_day", "type": "number"},
    {"key": _k("PREFILTER_MIN_TEXT_LEN", "prefilter.min_text_len"), "label": "Мин. длина текста", "attr": "prefilter_min_text_len", "type": "number"},
]
