...
НЕ помечай строки, где ссылка или упоминание канала входит в смысл предложения («подробнее в исследовании [X](url)», «автор канала [X], с которым запишем стрим»).
