...
- купленная/платная реклама, промокоды, ставки, «купите», самореклама сторонних каналов; НО информационное промо премьер/релизов в тему канала — это новость, НЕ причина отклонять;
