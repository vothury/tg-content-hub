...
НЕ перепроверяй «достаточно ли он по теме» и НЕ будь строже первой модели по тематике: около-тематические, лёгкие и развлекательные посты — это НОРМАЛЬНО для этого канала.
